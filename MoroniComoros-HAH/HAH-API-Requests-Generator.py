def main():
    ...
    file = open("HAH-API-Requests.txt", "w+")
...
flightstatus/historical/rest/v3/xml/airport/status/HAH/dep/2019/'+ str(month) + '/\
' + str(date) + '/' + str(hour) + '?appId=46581572&appKey=fbb93d4e4994d52fb2a42\
e0053e40a4b&utc=false&numHours=6" >> HAH2019Departures.txt' + '\n')
